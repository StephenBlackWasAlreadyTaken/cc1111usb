...
#ifdef VIRTUAL_COM
               .DB 32 				 ; bMaxPacketSize
			   .DB 0xfe, 0xff        ; idVendor Texas Instruments
			   .DB 0x0a, 0x00        ; idProduct CC1111
#else
...
0003$: ; Interface descriptor
               ...
               .DB 0x00                    ; iInterface
#ifdef VIRTUAL_COM
0004$:  ; Header functional descriptor
				.DB 0005$ - 0004$           ; bLength
				.DB CS_INTERFACE	        ; bDescriptorType
				.DB 0x00					; bDescriptor subtype header
				.DB 0x10, 0x01				; CDC version 1.1
0005$:  ; Call management functional descriptor
				.DB 0006$ - 0005$           ; bLength
				.DB CS_INTERFACE       	 	; bDescriptorType
				.DB 0x01					; bDescriptor subtype call mangement
				.DB 0x01					; bmCapabilities = device handles call management
				.DB 0x01					; bDataInterface call management interface number
0006$:  ; ACM functional descriptor
				.DB 0007$ - 0006$           ; bLength
				.DB CS_INTERFACE        	; bDescriptorType
				.DB 0x02					; bDescriptor subtype abstract control mangement
				.DB 0x02					; bmCapabilities = D1 (Set_line_Coding, Set_Control_Line_State, Get_Line_Coding and Serial_State)
0007$:  ; Union functional descriptor
				.DB 0010$ - 0007$           ; bLength
				.DB CS_INTERFACE       		; bDescriptorType
				.DB 0x06					; bDescriptor SubType Union Functional descriptor
				.DB 0x00					; bMasterInterface
				.DB 0x01					; bSlaveInterface0
0010$:  ; Notification EP
				.DB 0011$ - 0010$           ; bLength
				.DB USB_DESC_ENDPOINT       ; bDescriptorType
				.DB 0x81					; bEndpointAddress
				.DB 0x03					; bmAttributes = intr
				.DB 0x08, 0x00				; wMaxPacketsize
				.DB 0x0A					; bInterval
0011$:  ; Data class interface descriptor
				.DB 0012$ - 0011$           ; bLength
				.DB USB_DESC_INTERFACE      ; bDescriptorType
				.DB 0x01					; bInterfaceNumber
				.DB 0x00					; bAlternateSetting
				.DB 0x02					; bNumEndPoints
				.DB 0x0a					; bInterfaceClass = data
				.DB 0x00					; bInterfaceProtocol
				.DB 0x00					; iInterface
0012$:  ; EP IN
				.DB 0013$ - 0012$           ; bLength
				.DB USB_DESC_ENDPOINT       ; bDescriptorType
